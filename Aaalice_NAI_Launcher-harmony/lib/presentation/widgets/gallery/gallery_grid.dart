...
class GalleryGrid extends StatefulWidget {
  ...
  final void Function(LocalImageRecord record, int index)? onSendToVibeTransfer;     // 👈 插入这行
  final void Function(LocalImageRecord record, int index)? onSendToPreciseReference; // 👈 插入这行
...
class _GalleryImageCard extends StatefulWidget {
  ...
  final VoidCallback? onSendToVibeTransfer;     // 👈 插入这行
  final VoidCallback? onSendToPreciseReference; // 👈 插入这行
...
class _GalleryImageCardState extends State<_GalleryImageCard> {
  ...
  Widget build(BuildContext context) {
    return LocalImageCard3D(
      ...
      onSendToVibeTransfer: widget.onSendToVibeTransfer,         // 👈 插入这行
      onSendToPreciseReference: widget.onSendToPreciseReference, // 👈 插入这行
